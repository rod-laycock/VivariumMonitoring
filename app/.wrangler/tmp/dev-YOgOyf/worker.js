...
// .wrangler/tmp/bundle-eFpJS7/checked-fetch.js
...
<body>
  <div class="container">
    <header>
      <h1>\u{1F33F} Vivarium Monitor</h1>
    ...
    function displayData(data) {
      ...
      data.data.forEach(row => {
        ...
        tr.innerHTML = \`
          ...
          <td>\${row.sensor_id}</td>
          <td class="temp">\${Number(row.temperature).toFixed(1)}\xB0C</td>
...
// .wrangler/tmp/bundle-eFpJS7/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-eFpJS7/middleware-loader.entry.ts
